...
document.body.onload = solicitarDatos();
/******************************************************
...
function crearForm(array1, array2){
    ...
    //Creo boton de pedido
    let btnPedido = document.createElement("button");
        btnPedido.setAttribute("id", "btn")
        // btnPedido.setAttribute("type", "submit");
        // btnPedido.setAttribute("value", "Enviar pedido");
    let txtBtn = document.createTextNode("Enviar pedido");
    btnPedido.appendChild(txtBtn);
    
    form.appendChild(btnPedido);
